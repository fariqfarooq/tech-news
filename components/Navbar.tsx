...
export default function Navbar() {
  ...
  useEffect(()=>{
   const handleClickOutside = (e: MouseEvent) => {
     if(popupRef.current && !popupRef.current.contains(e.target as Node)) {
      //if the user has clicled outside the target element we set the isPopupVisible to false
      //we are getting target from e: MouseEvent
  ...
  return <div className="flex justify-between pb-4 border-b mb-4 relative">
    <div >
      <Link href={"/"} >
